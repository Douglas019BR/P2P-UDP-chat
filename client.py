...
class Client(protocol.DatagramProtocol):
    ...
    def choose_client(self):
        self.usr_addr = input("Enter your address: "), input("Enter your port: ")
    ...
    def datagramReceived(self, datagram, address):
        ...
        print(f"User {address} says: " + datagram)
    ...
    def send_message(self):
        while True:
            ...
            self.send_data(message, self.server)
...
if __name__ == "__main__":
    port = int(input("white your port :"))
